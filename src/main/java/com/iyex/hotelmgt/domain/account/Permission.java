...
public enum Permission {
    ...
    HOTELTYPE_CREATE,   HOTELTYPE_READ,   HOTELTYPE_UPDATE,   HOTELTYPE_DELETE,
    ROOM_CREATE,   ROOM_READ,   ROOM_UPDATE,   ROOM_DELETE,
    ROOMTYPE_CREATE,   ROOMTYPE_READ,   ROOMTYPE_UPDATE,   ROOMTYPE_DELETE,
    ...
    SERVICETYPE_CREATE, SERVICETYPE_READ, SERVICETYPE_UPDATE, SERVICETYPE_DELETE;
}
